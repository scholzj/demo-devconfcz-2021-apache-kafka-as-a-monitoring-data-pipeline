...
public class AlertingConfig {
    private static final Logger log = LogManager.getLogger(AlertingConfig.class);
    ...
    public AlertingConfig(String bootstrapServers, String applicationId, String sourceTopic, String targetTopic, int commitIntervalMs, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String additionalConfig) {
    ...
    public static AlertingConfig fromEnv() {
        ...
        return new AlertingConfig(bootstrapServers, applicationId, sourceTopic, targetTopic, commitIntervalMs, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, additionalConfig);
    }

    public static Properties createProperties(AlertingConfig config) {
